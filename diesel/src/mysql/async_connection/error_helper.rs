use crate::{result::DatabaseErrorKind, ConnectionError};
use mysql_async::Error;

pub(super) struct ErrorHelper(pub(super) Error);

impl From<ErrorHelper> for crate::result::Error {
    fn from(ErrorHelper(e): ErrorHelper) -> Self {
        match e {
            Error::Server(e) => {
                ...
                crate::result::Error::DatabaseError(kind, Box::new(e.message) as _)
            }
            e => crate::result::Error::DatabaseError(
...
impl From<ErrorHelper> for crate::result::ConnectionError {
    fn from(ErrorHelper(e): ErrorHelper) -> Self {
        match e {
