...
//! that provides a [`crate::connection::AsyncConnection`]
...
mod implementation {
    ...
    where
        C: crate::connection::Connection + 'static,
    ...
    where
        ...
        // Row bounds
        O: 'static + Send + for<'conn> crate::row::Row<'conn, C::Backend>,
        ...
        S: SpawnBlocking + Send,
    {
        ...
        async fn establish(database_url: &str) -> ConnectionResult<Self> {
            ...
            runtime
                ...
                .await
                .unwrap_or_else(|e| Err(crate::ConnectionError::BadConnection(e.to_string())))
    ...
    impl<T, C, S> AsyncTransactionManager<SyncConnectionWrapper<C, S>>
        for SyncTransactionManagerWrapper<T>
    where
        SyncConnectionWrapper<C, S>: AsyncConnection,
        C: Connection + 'static,
        S: SpawnBlocking,
        T: crate::connection::TransactionManager<C> + Send,
    {
