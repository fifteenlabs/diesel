...
/// A diesel-migration [`MigrationHarness`](crate::MigrationHarness) to run migrations
/// via an [`AsyncConnection`](diesel::connection::AsyncConnection)
///
...
///
/// ```ignore
/// # include!("../../diesel/src/async_doctest_setup.rs");
...
/// #
/// # #[cfg(all(feature = "async-postgres", feature = "deadpool"))]
...
/// #  }
/// #
/// # #[cfg(all(feature = "async-mysql", feature = "deadpool"))]
...
/// #  }
/// #
/// # #[cfg(all(feature = "async-sqlite", feature = "deadpool"))]
...
impl<C> crate::MigrationHarness<C::Backend> for AsyncMigrationHarness<C>
where
    C: AsyncConnection,
    AsyncConnectionWrapper<C>:
        diesel::Connection<Backend = C::Backend> + crate::MigrationHarness<C::Backend>,
{
    fn run_migration(
        &mut self,
        ...
        tokio::task::block_in_place(|| {
            crate::MigrationHarness::run_migration(&mut self.conn, migration)
        })
    }
    ...
    fn revert_migration(
        ...
        tokio::task::block_in_place(|| {
            crate::MigrationHarness::revert_migration(&mut self.conn, migration)
        })
    }

    fn applied_migrations(&mut self) -> Result<Vec<MigrationVersion<'static>>> {
        tokio::task::block_in_place(|| crate::MigrationHarness::applied_migrations(&mut self.conn))
    }
}
