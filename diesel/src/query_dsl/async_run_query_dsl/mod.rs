//! The async counterpart of [`RunQueryDsl`](crate::RunQueryDsl).
//!
//! Reachable as [`crate::async_dsl`], which is also where the reason these
//! traits keep their sync names is written down.

mod utils;

use crate::associations::HasTable;
use crate::connection::AsyncConnectionCore;
use crate::query_builder::IntoUpdateTarget;
use crate::result::QueryResult;
use crate::AsChangeset;
use futures_core::future::BoxFuture;
#[cfg(any(
    feature = "async-mysql",
    feature = "async-postgres",
    feature = "async-sqlite"
))]
...
pub mod return_futures {
    use crate::query_dsl::async_run_query_dsl::utils;
...
pub trait RunQueryDsl<Conn>: Sized {
    ...
    ///
    /// When asking the database to return data from a query, [`load`](crate::async_dsl::RunQueryDsl::load()) should
    ...
    /// [`execute`]: crate::async_dsl::RunQueryDsl::execute()
    ...
    ///
    /// [`load`]: crate::async_dsl::RunQueryDsl::load()
    ...
    fn first<'query, 'conn, U>(
        self,
        conn: &'conn mut Conn,
    ) -> return_futures::GetResult<'conn, 'query, crate::dsl::Limit<Self>, Conn, U>
    where
        U: Send + 'conn,
        Conn: AsyncConnectionCore,
        Self: crate::query_dsl::methods::LimitDsl,
        crate::dsl::Limit<Self>: methods::LoadQuery<'query, Conn, U> + Send + 'query,
    {
        crate::query_dsl::methods::LimitDsl::limit(self, 1).get_result(conn)
    }
}
...
/// # use schema::animals;
/// #
/// use diesel::{SaveChangesDsl, AsyncConnection};
///
...
pub trait SaveChangesDsl<Conn> {
    ...
    where
        Self: Sized + crate::prelude::Identifiable,
...
where
    Changes: crate::prelude::Identifiable + HasTable,
{
...
impl<'b, Changes, Output, Tab, V> UpdateAndFetchResults<Changes, Output>
    for crate::mysql::AsyncMysqlConnection
where
    Output: Send + 'static,
    Changes:
        Copy + AsChangeset<Target = Tab> + Send + crate::associations::Identifiable<Table = Tab>,
    Tab: crate::Table + crate::query_dsl::methods::FindDsl<Changes::Id> + 'b,
    crate::dsl::Find<Tab, Changes::Id>: IntoUpdateTarget<Table = Tab, WhereClause = V>,
    crate::query_builder::UpdateStatement<Tab, V, Changes::Changeset>:
        crate::query_builder::AsQuery,
    crate::dsl::Update<Changes, Changes>: methods::ExecuteDsl<Self>,
    V: Send + 'b,
    Changes::Changeset: Send + 'b,
    Changes::Id: 'b,
    Tab::FromClause: Send,
    crate::dsl::Find<Changes::Table, Changes::Id>:
        methods::LoadQuery<'b, crate::mysql::AsyncMysqlConnection, Output> + Send,
{
    fn update_and_fetch<'conn, 'changes>(
        &'conn mut self,
        changeset: Changes,
...
#[cfg(feature = "async-postgres")]
impl<'b, Changes, Output, Tab, V> UpdateAndFetchResults<Changes, Output>
    for crate::pg::AsyncPgConnection
where
    Output: Send + 'static,
    Changes:
        Copy + AsChangeset<Target = Tab> + Send + crate::associations::Identifiable<Table = Tab>,
    ...
    crate::query_builder::UpdateStatement<Tab, V, Changes::Changeset>:
        crate::query_builder::AsQuery,
    crate::dsl::Update<Changes, Changes>: methods::LoadQuery<'b, Self, Output>,
    V: Send + 'b,
    Changes::Changeset: Send + 'b,
    Tab::FromClause: Send,
{
